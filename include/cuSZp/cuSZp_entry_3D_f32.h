...
void cuSZp_decompress_3D_outlier_f32(float* d_decData, unsigned char* d_cmpBytes, size_t nbEle, size_t cmpSize, uint3 dimes, float errorBound, cudaStream_t stream = 0);
void cuSZp_profile_3D_plain_f32(float* d_oriData, unsigned char* d_cmpBytes, size_t nbEle, size_t* cmpSize, uint3 dims, float range, int sample_rate, cudaStream_t stream = 0);
void cuSZp_profile_3D_outlier_f32(float* d_oriData, unsigned char* d_cmpBytes, size_t nbEle, size_t* cmpSize, uint3 dims, float range, int sample_rate, cudaStream_t stream = 0);
